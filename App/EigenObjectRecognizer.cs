...
namespace Emgu.CV {
    ...
    /// </summary>
    [Serializable]
    public class CustomEigenObjectRecognizer {
        ...
        private CustomEigenObjectRecognizer() {
        }
        ...
        public CustomEigenObjectRecognizer(Image<Gray, Byte>[] images, ref MCvTermCriteria termCrit)
        ...
        /// <param name="termCrit">The criteria for recognizer training</param>
        public CustomEigenObjectRecognizer(Image<Gray, Byte>[] images, String[] labels, ref MCvTermCriteria termCrit)
        ...
        /// </param>
        /// <param name="termCrit">The criteria for recognizer training</param>
        public CustomEigenObjectRecognizer(Image<Gray, Byte>[] images, String[] labels, double eigenDistanceThreshold, ref MCvTermCriteria termCrit) {
